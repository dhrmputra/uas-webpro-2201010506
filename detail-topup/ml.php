...
<body style="background-color: #161619;color:white">
    ...
    <div class="container-fluid d-relative" style="background-image: url('../img/bgml2.jpg');width:100%;background-size:100% 100%;height:400px; margin-bottom: -120px;"></div>
            ...
            <div class="col-md-7">
                <form method="POST" action="./datatopup.php" class="bg-dark shadow" style="padding: 40px;">
                    ...
                    <div class="form-check my-4 text-center">
                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white w-25" onclick="harga('1514')"><input type="radio" class="form-check-input ms-4 mt-1" value="3 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">3 Diamonds</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('5045')"><input type="radio" class="form-check-input mt-1" value="14 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">11 + 3 Diamonds</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('20182')"><input type="radio" class="form-check-input mt-1" value="59 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">53 + 6 Diamonds</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('60545')"><input type="radio" class="form-check-input mt-1" value="170 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">154 + 16 Diamonds</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('100909')"><input type="radio" class="form-check-input mt-1" value="296 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">256 + 40 Diamonds</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('302727')"><input type="radio" class="form-check-input mt-1" value="875 Diamonds" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">774 + 101 Diamonds</span>
                    </div>
