...
<body style="background-color: #161619;color:white">
    ...
    <div class="container-fluid d-relative" style="background-image: url('../img/bggenshin.jpeg');width:100%;background-size:100% 100%;height:400px; margin-bottom: -120px;"></div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-5">
                <img src="../img/logogenshin.jpg" class="rounded-circle border-white border" style="width: 100px;height:100px;margin:0 0 20px 0px">
                <h4 class="fw-bold">Genshin Impact</h4>
                <hr class="w-75">
            ...
            <div class="col-md-7">
                <form method="POST" action="./datatopup.php" class="bg-dark shadow" style="padding: 40px;">
                    ...
                    <h4 class="mb-4">Masukan UID Anda</h4>
                    <div class="d-flex my-4">
                        <input type="text" name="gameid" placeholder="Silahkan Masukan ID anda" class="form-control w-100 me-4 p-2">
                        <input type="text" name="zoneid" placeholder="Zone ID" class="form-control w-25">
                    </div>
                    <h4 class="my-4">Pilih Jumlah Genesis Crystal Yang Ingin Anda beli</h4>
                    <div class="form-check my-4 text-center">
                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white w-25" onclick="harga('16500')"><input type="radio" class="form-check-input ms-4 mt-1" value="60 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">60 Genesis Crystal</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('81000')"><input type="radio" class="form-check-input mt-1" value="300 + 30 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">300 + 30 Genesis Crystal</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('255000')"><input type="radio" class="form-check-input mt-1" value="980 + 110 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">980 + 110 Genesis Crystal</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('489000')"><input type="radio" class="form-check-input mt-1" value="1980 + 260 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">1980 + 260 Genesis Crystal</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('815000')"><input type="radio" class="form-check-input mt-1" value="3280 + 600 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">3280 + 600 Genesis Crystal</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('1629000')"><input type="radio" class="form-check-input mt-1" value="6480 + 1600 Genesis Crystal" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">6480 + 1600 Genesis Crystal</span>
                    </div>
