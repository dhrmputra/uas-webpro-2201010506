...
<body style="background-color: #161619;color:white">
    ...
    <div class="container-fluid d-relative" style="background-image: url('../img/bgnetflix.jpg');width:100%;background-size:100% 100%;height:400px; margin-bottom: -120px;"></div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-5">
                <img src="../img/logonetflix.jpg" class="rounded-circle border-white border" style="width: 100px;height:100px;margin:0 0 20px 0px">
                <h4 class="fw-bold">Netflix</h4>
                <hr class="w-75">
            ...
            <div class="col-md-7">
                <form method="POST" action="./datatopup.php" class="bg-dark shadow" style="padding: 40px;">
                    ...
                    <h4 class="mb-4">Masukan Nomor Telepon Legends Anda</h4>
                    <div class="d-flex my-4">
                        <input type="text" name="gameid" placeholder="Silahkan Masukan Nomor telepon anda" class="form-control w-100 me-4 p-2">
                    ...
                    <div class="form-check my-4 text-center">
                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white w-25" onclick="harga('61999')"><input type="radio" class="form-check-input ms-4 mt-1" value="Langganan Netflix" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">Langganan Netflix</span>
                    </div>
