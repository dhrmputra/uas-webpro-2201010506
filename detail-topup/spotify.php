...
<body style="background-color: #161619;color:white">
    ...
    <div class="container-fluid d-relative" style="background-image: url('../img/bgspotify.jpg');width:100%;background-size:100% 100%;height:400px; margin-bottom: -120px;"></div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-5">
                <img src="../img/logospotify.jpg" class="rounded-circle border-white border" style="width: 100px;height:100px;margin:0 0 20px 0px">
                <h4 class="fw-bold">Spotify Premium</h4>
                <hr class="w-75">
            ...
            <div class="col-md-7">
                <form method="POST" action="./datatopup.php" class="bg-dark shadow" style="padding: 40px;">
                    ...
                    <div class="form-check my-4 text-center">
                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white w-25" onclick="harga('59999')"><input type="radio" class="form-check-input ms-4 mt-1" value="Premium Bulanan" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">Premium Bulanan</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('5499')"><input type="radio" class="form-check-input mt-1" value="Premium Harian" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">Premium harian</span>
