...
<body style="background-color: #161619;color:white">
    ...
    <div class="container-fluid d-relative" style="background-image: url('../img/bgvalo.jpg');width:100%;background-size:100% 100%;height:400px; margin-bottom: -120px;"></div>
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-5">
                <img src="../img/logoml.jpg" class="rounded-circle border-white border" style="width: 100px;height:100px;margin:0 0 20px 0px">
                <h4 class="fw-bold">Valorant</h4>
                <hr class="w-75">
            ...
            <div class="col-md-7">
                <form method="POST" action="./datatopup.php" class="bg-dark shadow" style="padding: 40px;">
                    ...
                    <h4 class="mb-4">Masukan Game ID Mobile Legends Anda</h4>
                    <div class="d-flex my-4">
                        <input type="text" name="gameid" placeholder="Silahkan nickname Anda" class="form-control w-100 me-4 p-2">
                        <input type="text" name="zoneid" placeholder="Tagline Anda" class="form-control w-25">
                    </div>
                    <h4 class="my-4">Pilih Jumlah Diamond Yang Ingin Anda beli</h4>
                    <div class="form-check my-4 text-center">
                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white w-25" onclick="harga('1412  ')"><input type="radio" class="form-check-input ms-4 mt-1" value="125 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">125 Points</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('47532')"><input type="radio" class="form-check-input mt-1" value="420 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">420 Points</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25" onclick="harga('76000')"><input type="radio" class="form-check-input mt-1" value="700 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">700 Points</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('237500')"><input type="radio" class="form-check-input mt-1" value="2400 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">2400 Points</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('380000')"><input type="radio" class="form-check-input mt-1" value="4000 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">4000 Points</span>

                        <span class="btn btn-dark fs-6 fw-bold me-4 border border-white  w-25 mt-4" onclick="harga('760000')"><input type="radio" class="form-check-input mt-1" value="8150 Points" name="pesanan" id="flexRadioDefault1" style="margin-left: 10px;">8150 Points</span>
                    </div>
